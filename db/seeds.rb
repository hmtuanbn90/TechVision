...
User.create(name:"Hoang Tung",password:"123456",email:"hoangvantung6.it@gmail.com",admin:true )
...
Review.create(title:"Xiaomi ra mat mibad 11",user_id:1,content:"Ngoài Twitter hay Instagram thì nhiều dịch vụ khác cũng tích hợp hashtag vào hệ thống của mình, ví dụ như trong hệ thống đăng lời bình luận của YouTube hay Google+. Những công cụ tìm kiếm theo thời gian thực như Google Real-Time Search (một tính năng của Google Search) sẽ tự theo dõi một hashtag do bạn chỉ định để liên tục hiển thị những bài post được gắn tag đó.",about:"hashtag còn được cộng đồng mạng sử dụng như một biện pháp để giải bày một trạng thái nào đó liên quan đến thông điệp", hot:true, view:202,topic_id:2, appended: false )
Review.create(title:"Xiaomi ra mat mibad 12",user_id:1,content:"Ngoài Twitter hay Instagram thì nhiều dịch vụ khác cũng tích hợp hashtag vào hệ thống của mình, ví dụ như trong hệ thống đăng lời bình luận của YouTube hay Google+. Những công cụ tìm kiếm theo thời gian thực như Google Real-Time Search (một tính năng của Google Search) sẽ tự theo dõi một hashtag do bạn chỉ định để liên tục hiển thị những bài post được gắn tag đó.",about:"hashtag còn được cộng đồng mạng sử dụng như một biện pháp để giải bày một trạng thái nào đó liên quan đến thông điệp", hot:true, view:202,topic_id:2, appended: false )
Review.create(title:"Xiaomi ra mat mibad 13",user_id:1,content:"Ngoài Twitter hay Instagram thì nhiều dịch vụ khác cũng tích hợp hashtag vào hệ thống của mình, ví dụ như trong hệ thống đăng lời bình luận của YouTube hay Google+. Những công cụ tìm kiếm theo thời gian thực như Google Real-Time Search (một tính năng của Google Search) sẽ tự theo dõi một hashtag do bạn chỉ định để liên tục hiển thị những bài post được gắn tag đó.",about:"hashtag còn được cộng đồng mạng sử dụng như một biện pháp để giải bày một trạng thái nào đó liên quan đến thông điệp", hot:true, view:202,topic_id:2, appended: false )
Review.create(title:"Xiaomi ra mat mibad 14",user_id:1,content:"Ngoài Twitter hay Instagram thì nhiều dịch vụ khác cũng tích hợp hashtag vào hệ thống của mình, ví dụ như trong hệ thống đăng lời bình luận của YouTube hay Google+. Những công cụ tìm kiếm theo thời gian thực như Google Real-Time Search (một tính năng của Google Search) sẽ tự theo dõi một hashtag do bạn chỉ định để liên tục hiển thị những bài post được gắn tag đó.",about:"hashtag còn được cộng đồng mạng sử dụng như một biện pháp để giải bày một trạng thái nào đó liên quan đến thông điệp", hot:true, view:202,topic_id:2, appended: false )
Review.create(title:"Xiaomi ra mat mibad 15",user_id:1,content:"Ngoài Twitter hay Instagram thì nhiều dịch vụ khác cũng tích hợp hashtag vào hệ thống của mình, ví dụ như trong hệ thống đăng lời bình luận của YouTube hay Google+. Những công cụ tìm kiếm theo thời gian thực như Google Real-Time Search (một tính năng của Google Search) sẽ tự theo dõi một hashtag do bạn chỉ định để liên tục hiển thị những bài post được gắn tag đó.",about:"hashtag còn được cộng đồng mạng sử dụng như một biện pháp để giải bày một trạng thái nào đó liên quan đến thông điệp", hot:true, view:202,topic_id:2, appended: false )
